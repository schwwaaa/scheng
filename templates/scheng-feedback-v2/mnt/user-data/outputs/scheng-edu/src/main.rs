    ...
    fn load_shaders(&mut self) {
        ...
        match std::fs::read_dir(&dir) {
            Err(e) => {
                ...
                log::error!("Run from the scheng-edu project root: cd /Users/tgm/Documents/SPLASH/scheng-edu && cargo run --release");
                return;
            }
            Ok(entries) => {
    ...
    fn resumed(&mut self, event_loop: &ActiveEventLoop) {
        let win = Arc::new(event_loop.create_window(
            Window::default_attributes()
                .with_title("scheng-edu  |  →/] next scene  |  ←/[ prev  |  CC7=0 key mode")
        ...
        let midi_result = (|| -> Result<midir::MidiInputConnection<()>, String> {
            let mut m = MidirInput::new("scheng-edu")
        ...
        let (rw, rh) = render_size(self.args.width, self.args.height, self.args.render_scale);
        log::info!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
        log::info!("  scheng-edu  display={}×{}  render={}×{}  MSAA {}×",
