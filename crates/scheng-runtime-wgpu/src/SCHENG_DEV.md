...
- [x] Custom u_* uniform injection — Phase 1.2
  - NodeConfig::uniforms HashMap<String, f32>
  - compat.rs: u_name → u_custom[N] replacement, CustomBlock at binding 6
  - uniforms.rs: CustomUniformBuffer per node
  - pipeline.rs: binding 6 in BGL
  - executor.rs: writes CustomBlock per draw call
  - 2 new tests: test_custom_uniforms_reach_shader, test_custom_uniform_zero_default
