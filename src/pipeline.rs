...
pub struct NodePipeline {
    /// The wgpu render pipeline — ready to use in a render pass.
    pub pipeline: wgpu::RenderPipeline,
    /// The bind group layout — needed to create bind groups each frame.
...
fn build_pipeline(
    ...
    Ok(NodePipeline { pipeline, bind_group_layout })
}
